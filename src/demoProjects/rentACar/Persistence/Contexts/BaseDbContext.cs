    ...
    public class BaseDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
           ...
           modelBuilder.Entity<Model>(a =>
            ...
            //Ana entity'e [Key] yazılamama sebebi solid prensiplerine ayıkırı olması

            Brand[] brandSeedData = { new(1, "TOFAŞ"), new(2, "BMW") };
            modelBuilder.Entity<Brand>().HasData(brandSeedData);

            Model[] modelSeedData = { new(1,1,"Series 4",1500,""),new(2,1,"Series 7",1500,""),new(3,2,"Series 3",1500,""),new(4,2,"Series 4",1500,"")};
